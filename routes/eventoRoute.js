...
const { actualizarEvento, borrarEvento, crearEvento, getEvento, getEventoByID, getEventoByNombre, getEventoBySitio, getEventoBySitioPaginado, getEventoByTalentPaginado } = require('../controllers/eventoController');
